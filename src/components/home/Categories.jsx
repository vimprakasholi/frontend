...
const Categories = () => {
  return (
    <section
      id="categories"
      className="py-12 md:py-28 bg-slate-100 dark:bg-slate-700 dark:text-white"
    >
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8">
          <Link href={`${PRODUCTS_ROUTE}?category=Laptops`}>
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition p-6 flex flex-col items-center justify-between gap-2">
              <div className="text-primary text-4xl bg-slate-100 dark:bg-slate-700 p-5 h-20 w-20 rounded-full flex items-center justify-center">
                <FaLaptop />
              </div>
